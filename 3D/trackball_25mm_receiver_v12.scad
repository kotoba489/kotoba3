// trackball_25mm_receiver_v12.scad
//
// Description:
// Custom 25mm trackball receiver for PMW3610 breakout sensor board (Version 12).
//
// Updates in v12:
// - Ultimate stability model: combines 17.0 mm cup depth (v9/v11) with the physical limit
//   for lateral stability: raising the support balls to contact angle 55 degrees.
// - Place support balls at Z=14.00 mm (exactly 0.92 mm higher than v10/v11) and wider (Rs=10.85 mm).
...
// Bounding box total height raised to 17.0 mm for maximum cup depth
total_h = 17.0;
