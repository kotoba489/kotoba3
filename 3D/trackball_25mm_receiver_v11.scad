// trackball_25mm_receiver_v11.scad
//
// Description:
// Custom 25mm trackball receiver for PMW3610 breakout sensor board (Version 11).
//
// Updates in v11:
// - Combines the maximum cup depth (height 17.0 mm, matching v9) with the maximum lateral stability
//   by raising the support balls vertically (contact angle 50 degrees, matching v10).
// - Place support balls at Z=13.08 mm instead of 12.23 mm for optimal lateral hold.
